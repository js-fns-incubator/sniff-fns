...
const isAndroidMobile = require('.')

test('isAndroidMobile returns true when a user agent string is belongs to Anrdoid Mobile browser', (t) => {
  ;[
    ...
    t.true(isAndroidMobile(ua))
  })
})

test('isAndroid returns false for a non-Android Mobile user agent string', (t) => {
  ;[
