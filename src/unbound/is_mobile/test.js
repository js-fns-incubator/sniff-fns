...
test('isMobile returns true if a user agent belongs to a mobile browser', (t) => {
  ;[
...
test("isMobile returns false if a user agent doesn't belong to a mobile browser", (t) => {
  ;[
