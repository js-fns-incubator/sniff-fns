...
const isAndroid = require('.')

test('isAndroid returns true when a user agent string is belongs to Anrdoid', (t) => {
  ;[
...
test('isAndroid returns false for a non-Android user agent string', (t) => {
  ;[
