...
const isIpad = require('.')

test('isIpad returns true if a user agent string belongs to iPad', (t) => {
  ;[
...
test("isIpad returns false if a user agent string doesn't belong to iPad", (t) => {
  ;[
