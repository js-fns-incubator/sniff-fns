...
const isIphone = require('.')

test('isIphone returns true if a user agent string belongs to iPhone', (t) => {
  ;[
...
test("isIphone returns true if a user agent string doesn't belong to iPhone", (t) => {
  ;[
