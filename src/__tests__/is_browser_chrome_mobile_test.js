...
describe('isChromeMobile', function(){
  it('returns true if string belongs to chrome mobile\'s user agent', function(){
    ...
    expect(isArrayPassFunction(ChromeMobileUserAgents, isChromeMobile)).to.be.true;
  });
  ...
  it('returns false if string doesn\'t belongs to chrome\'s user agent', function(){
    ...
    expect(isArrayPassFunction(NotChromeMobileUserAgents, isChromeMobile)).to.be.false;
  });
});
